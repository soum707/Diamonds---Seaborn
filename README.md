<body>
    <div class="container">
        ...
        <p>This project utilizes the Diamonds dataset from Seaborn to predict diamond prices based on various given variables.<br><br> Several machine learning models were implemented, including K-Nearest Neighbors (KNN), Linear Regression, and Random Forest.</p>
